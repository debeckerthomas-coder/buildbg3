  ...
  theme: {
    extend: {
      ...
      colors: {
        // Fonds
        bg: {
          void:    'rgb(5 6 10 / <alpha-value>)',
          deep:    'rgb(8 10 18 / <alpha-value>)',
          base:    'rgb(12 14 24 / <alpha-value>)',
          raised:  'rgb(16 19 32 / <alpha-value>)',
          surface: 'rgb(22 26 44 / <alpha-value>)',
        },
        // Or (accent principal)
        gold: {
          DEFAULT: 'rgb(212 168 87 / <alpha-value>)',
          light:   'rgb(240 208 144 / <alpha-value>)',
          pale:    'rgb(245 224 176 / <alpha-value>)',
          dark:    'rgb(160 120 48 / <alpha-value>)',
        },
        // Violet (accent secondaire — Occultiste)
        violet: {
          DEFAULT: 'rgb(139 92 246 / <alpha-value>)',
          light:   'rgb(167 139 250 / <alpha-value>)',
        },
        // Rouge (danger / Honneur)
        danger: {
          DEFAULT: 'rgb(255 59 59 / <alpha-value>)',
          dark:    'rgb(204 32 32 / <alpha-value>)',
        },
        // Texte
        text: {
          primary:   'rgb(232 224 240 / <alpha-value>)',
          secondary: 'rgb(168 160 184 / <alpha-value>)',
          muted:     'rgb(107 101 128 / <alpha-value>)',
          dim:       'rgb(74 69 96 / <alpha-value>)',
          gold:      'rgb(212 168 87 / <alpha-value>)',
          bright:    'rgb(255 255 255 / <alpha-value>)',
        },
        // Difficulté
        diff: {
          easy:    '#10b981',
        ...
        amber:   { DEFAULT: 'rgb(245 158 11 / <alpha-value>)' },
      },
