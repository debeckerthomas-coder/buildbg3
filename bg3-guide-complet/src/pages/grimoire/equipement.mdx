...
N'oubliez jamais d'utiliser l'action <Tooltip name="Lier l'arme de pacte" type="Action de Classe — Occultiste Niv.3" stats="Lie l'arme · Attaques utilisent CHA" client:idle>L'arme liée utilise votre Charisme pour les jets d'attaque ET de dégâts. Elle revient en main si vous la jetez. Elle ne peut pas vous être volée. À refaire après chaque repos long.</Tooltip> après chaque repos long. Sans cela, vous frappez à la Force 10 — vous ratez tout.
</CalloutBlock>
...
Commencez avec la <Tooltip name="Lame Éternelle" type="Espadon Inhabituel" rarity="uncommon" stats="+1d4 Feu" client:idle>Récupérée au Nautiloïde via Injonction sur Zhalk. Excellente arme de départ pour les niveaux 1-4.</Tooltip> (Nautiloïde), puis passez au <Tooltip name="Sang de Lathandre" type="Masse Légendaire +3" rarity="legendary" stats="Sunbeam 1×/repos · Survie 1× si PV → 0" client:idle>Votre arme principale pour l'Acte 1 et 2. Les dégâts radiants sont dévastateurs contre les morts-vivants de l'Acte 2. Le Sunbeam peut aveugler les boss.</Tooltip> + bouclier dès la Crèche Y'llek.
